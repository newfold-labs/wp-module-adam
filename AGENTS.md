# Agent guidance – wp-module-adam

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-adam** – Newfold module for Adam (Ads and More) cross-sell content in brand plugins. Registers with the Newfold Module Loader; depends on wp-module-context, wp-module-data, wp-module-features. Maintained by Newfold Labs.

- **Stack:** PHP 7.3+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; provides Adam cross-sell content. See docs/integration.md.
